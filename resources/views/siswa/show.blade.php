...
@section('konten')
   <div>    
        ...
        <div class="">
            ...
            <div class="d-flex gap-3">
                <p class="text-start p-0 m-0"><span class="fw-bold">Jumlah Pengguna :</span> {{ $data->jumlah_pengguna}}</p>
            </div>
            <div class="d-flex gap-3">
            ...
            <div class="d-flex gap-3">
                <p class="text-start p-0 m-0"><span class="fw-bold">Apakah aplikasi ini memiliki dokumen Proses Bisnis atau SOP yang berkaitan ?(lampirkan
                    jika ada) : </span>
                    <img style="max-width:400px;max-height:400px" src="{{ url('foto_sop').'/'.$data->foto_sop }}"/>
            ...
            <div class="d-flex gap-3">
                ...
                <img style="max-width:400px;max-height:400px" src="{{ url('foto_layar').'/'.$data->foto_layar }}"/>
                </p>
            </div>
            <div class="d-flex gap-3">
            ...
            <div class="d-flex gap-3">
                <p class="text-start p-0 m-0"><span class="fw-bold">Rapat Evaluasi yang berkaitan dengan aplikasi :</span>               
                    <img style="max-width:400px;max-height:400px" src="{{ url('foto_rapat').'/'.$data->foto_rapat }}"/>
                </p>
            </div>
            <div class="d-flex gap-3">
